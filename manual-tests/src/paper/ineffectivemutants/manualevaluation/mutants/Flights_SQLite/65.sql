-- 65
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged FLIGHT_ID with MEAL
...
CREATE TABLE "Flights" (
	...
	PRIMARY KEY ("MEAL", "SEGMENT_NUMBER"),
