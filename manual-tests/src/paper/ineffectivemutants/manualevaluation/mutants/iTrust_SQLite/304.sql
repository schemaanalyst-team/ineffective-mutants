-- 304
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OVMedicationID, ID) with Pair(OVMedicationID, StartDate)
...
CREATE TABLE "OVReactionOverride" (
	"ID"	INT	PRIMARY KEY,
	"OVMedicationID"	INT	 REFERENCES "OVMedication" ("StartDate")	NOT NULL,
