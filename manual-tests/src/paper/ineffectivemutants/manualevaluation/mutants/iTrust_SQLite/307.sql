-- 307
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OVMedicationID, ID) with Pair(OVMedicationID, Instructions)
...
CREATE TABLE "OVReactionOverride" (
	"ID"	INT	PRIMARY KEY,
	"OVMedicationID"	INT	 REFERENCES "OVMedication" ("Instructions")	NOT NULL,
