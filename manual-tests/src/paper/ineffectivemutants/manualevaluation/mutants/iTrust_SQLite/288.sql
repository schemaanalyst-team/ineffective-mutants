-- 288
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(OverrideCode, VisitID)
...
CREATE TABLE "OVReactionOverride" (
	...
	FOREIGN KEY ("OVMedicationID", "OverrideCode") REFERENCES "OVMedication" ("ID", "VisitID")
)
