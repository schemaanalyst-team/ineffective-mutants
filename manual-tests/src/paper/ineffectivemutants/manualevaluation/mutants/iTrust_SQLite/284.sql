-- 284
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(ID, StartDate)
...
CREATE TABLE "OVReactionOverride" (
	...
	FOREIGN KEY ("OVMedicationID", "ID") REFERENCES "OVMedication" ("ID", "StartDate")
)
