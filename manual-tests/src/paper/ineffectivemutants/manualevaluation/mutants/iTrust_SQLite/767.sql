-- 767
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with Instructions
...
CREATE TABLE "OVMedication" (
	...
	"EndDate"	DATE,
	"Dosage"	INT,
	"Instructions"	VARCHAR(500)	PRIMARY KEY
)
