-- 302
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OVMedicationID, ID) with Pair(OVMedicationID, VisitID)
...
CREATE TABLE "OVReactionOverride" (
	"ID"	INT	PRIMARY KEY,
	"OVMedicationID"	INT	 REFERENCES "OVMedication" ("VisitID")	NOT NULL,
