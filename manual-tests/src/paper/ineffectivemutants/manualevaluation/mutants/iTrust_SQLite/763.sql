-- 763
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged ID with NDCode
...
CREATE TABLE "OVMedication" (
	"ID"	INT,
	"VisitID"	INT	NOT NULL,
	"NDCode"	VARCHAR(9)	PRIMARY KEY	NOT NULL,
	"StartDate"	DATE,
	"EndDate"	DATE,
	"Dosage"	INT,
