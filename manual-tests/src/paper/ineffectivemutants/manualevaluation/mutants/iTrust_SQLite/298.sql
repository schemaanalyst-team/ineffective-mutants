-- 298
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(OverrideComment, Dosage)
...
CREATE TABLE "OVReactionOverride" (
	...
	FOREIGN KEY ("OVMedicationID", "OverrideComment") REFERENCES "OVMedication" ("ID", "Dosage")
)
