-- 296
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(OverrideComment, StartDate)
...
CREATE TABLE "OVReactionOverride" (
	...
	FOREIGN KEY ("OVMedicationID", "OverrideComment") REFERENCES "OVMedication" ("ID", "StartDate")
)
