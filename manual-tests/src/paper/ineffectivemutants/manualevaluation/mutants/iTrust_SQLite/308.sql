-- 308
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OVMedicationID, ID) with Pair(OverrideCode, ID)
...
CREATE TABLE "OVReactionOverride" (
	...
	"OverrideCode"	VARCHAR(5)	 REFERENCES "OVMedication" ("ID"),
