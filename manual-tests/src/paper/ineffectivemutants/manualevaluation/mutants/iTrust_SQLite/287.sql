-- 287
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(ID, Instructions)
...
CREATE TABLE "OVReactionOverride" (
	...
	FOREIGN KEY ("OVMedicationID", "ID") REFERENCES "OVMedication" ("ID", "Instructions")
)
