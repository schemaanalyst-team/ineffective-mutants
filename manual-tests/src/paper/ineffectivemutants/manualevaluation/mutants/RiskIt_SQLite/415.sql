-- 415
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(INDUSTRYCODE, INDUSTRYCODE) with Pair(INDUSTRYCODE, INDUSTRY)
...
CREATE TABLE "wage" (
	"INDUSTRYCODE"	INT	 REFERENCES "industry" ("INDUSTRY")	NOT NULL,
