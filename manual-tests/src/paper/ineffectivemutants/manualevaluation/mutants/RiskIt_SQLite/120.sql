-- 120
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(WORKCLASS, CITIZENSHIP)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("SSN", "WORKCLASS") REFERENCES "userrecord" ("SSN", "CITIZENSHIP")
)
