-- 325
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(EDUENROLL, SSN)
...
CREATE TABLE "education" (
	"SSN"	INT	PRIMARY KEY	NOT NULL,
	"EDUCATION"	CHAR(50),
	"EDUENROLL"	CHAR(50)	 REFERENCES "userrecord" ("SSN")
)
