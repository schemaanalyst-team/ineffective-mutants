-- 179
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(WEEKWAGE, TAXSTAT)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("SSN", "WEEKWAGE") REFERENCES "userrecord" ("SSN", "TAXSTAT")
)
