-- 42
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EMPLOYMENTSTAT, AGE)
...
CREATE TABLE "employmentstat" (
	...
	FOREIGN KEY ("SSN", "EMPLOYMENTSTAT") REFERENCES "userrecord" ("SSN", "AGE")
)
