-- 31
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(UNEMPLOYMENTREASON, MARITAL)
...
CREATE TABLE "employmentstat" (
	...
	FOREIGN KEY ("SSN", "UNEMPLOYMENTREASON") REFERENCES "userrecord" ("SSN", "MARITAL")
)
