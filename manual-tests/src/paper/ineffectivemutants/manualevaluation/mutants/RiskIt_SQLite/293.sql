-- 293
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(PARENTS, RACE)
...
CREATE TABLE "youth" (
	"SSN"	INT	PRIMARY KEY	NOT NULL,
	"PARENTS"	CHAR(50),
	FOREIGN KEY ("SSN", "PARENTS") REFERENCES "userrecord" ("SSN", "RACE")
)
