-- 251
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MIGRATIONDISTANCE, MOTHERORIGIN)
...
CREATE TABLE "migration" (
	...
	FOREIGN KEY ("SSN", "MIGRATIONDISTANCE") REFERENCES "userrecord" ("SSN", "MOTHERORIGIN")
)
