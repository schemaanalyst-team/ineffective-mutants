-- 239
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MIGRATIONCODE, BIRTHCOUNTRY)
...
CREATE TABLE "migration" (
	...
	FOREIGN KEY ("SSN", "MIGRATIONCODE") REFERENCES "userrecord" ("SSN", "BIRTHCOUNTRY")
)
