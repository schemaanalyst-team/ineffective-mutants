-- 319
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(SSN, HOUSEHOLDDETAIL)
...
CREATE TABLE "education" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("HOUSEHOLDDETAIL")	NOT NULL,
	"EDUCATION"	CHAR(50),
	"EDUENROLL"	CHAR(50)
)
