-- 224
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(SELFEMPLOYED, INDUSTRY)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("INDUSTRYCODE", "SELFEMPLOYED") REFERENCES "industry" ("INDUSTRYCODE", "INDUSTRY")
)
