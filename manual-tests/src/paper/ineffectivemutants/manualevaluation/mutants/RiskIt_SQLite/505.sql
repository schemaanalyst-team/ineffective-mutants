-- 505
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with BIRTHCOUNTRY
...
CREATE TABLE "userrecord" (
	...
	"BIRTHCOUNTRY"	CHAR(50)	PRIMARY KEY,
	"CITIZENSHIP"	CHAR(50)
)
