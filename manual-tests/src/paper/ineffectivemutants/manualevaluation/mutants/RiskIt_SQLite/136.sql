-- 136
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(OCCUPATIONCODE, AGE)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("SSN", "OCCUPATIONCODE") REFERENCES "userrecord" ("SSN", "AGE")
)
