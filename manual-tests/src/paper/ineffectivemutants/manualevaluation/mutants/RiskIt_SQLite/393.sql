-- 393
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(INDUSTRYCODE, INDUSTRYCODE) with Pair(UNIONMEMBER, INDUSTRYCODE)
...
CREATE TABLE "job" (
	...
	"UNIONMEMBER"	CHAR(50)	 REFERENCES "industry" ("INDUSTRYCODE"),
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT,
