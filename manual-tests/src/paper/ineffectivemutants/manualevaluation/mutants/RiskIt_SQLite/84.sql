-- 84
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(STOCKDIVIDENDS, RACE)
...
CREATE TABLE "investment" (
	...
	"CAPITALLOSSES"	INT,
	"STOCKDIVIDENDS"	INT,
	FOREIGN KEY ("SSN", "STOCKDIVIDENDS") REFERENCES "userrecord" ("SSN", "RACE")
)
