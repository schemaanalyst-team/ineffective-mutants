-- 209
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(WORKWEEKS, MOTHERORIGIN)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("SSN", "WORKWEEKS") REFERENCES "userrecord" ("SSN", "MOTHERORIGIN")
)
