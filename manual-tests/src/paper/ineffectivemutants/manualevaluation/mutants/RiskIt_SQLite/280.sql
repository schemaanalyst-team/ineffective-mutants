-- 280
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(OCCUPATIONCODE, INDUSTRY)
...
CREATE TABLE "wage" (
	...
	FOREIGN KEY ("INDUSTRYCODE", "OCCUPATIONCODE") REFERENCES "industry" ("INDUSTRYCODE", "INDUSTRY")
)
