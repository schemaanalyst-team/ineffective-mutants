-- 101
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EMPLOYERSIZE, STABILITY)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("OCCUPATIONCODE", "EMPLOYERSIZE") REFERENCES "occupation" ("OCCUPATIONCODE", "STABILITY")
)
