-- 504
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with MOTHERORIGIN
...
CREATE TABLE "userrecord" (
	...
	"MOTHERORIGIN"	CHAR(50)	PRIMARY KEY,
