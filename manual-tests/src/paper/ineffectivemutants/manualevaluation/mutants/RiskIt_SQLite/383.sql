-- 383
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(UNIONMEMBER, SSN)
...
CREATE TABLE "job" (
	...
	"UNIONMEMBER"	CHAR(50)	 REFERENCES "userrecord" ("SSN"),
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT,
