-- 218
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(UNIONMEMBER, INDUSTRY)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("INDUSTRYCODE", "UNIONMEMBER") REFERENCES "industry" ("INDUSTRYCODE", "INDUSTRY")
)
