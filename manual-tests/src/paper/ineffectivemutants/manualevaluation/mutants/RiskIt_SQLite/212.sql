-- 212
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(SSN, INDUSTRY)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("INDUSTRYCODE", "SSN") REFERENCES "industry" ("INDUSTRYCODE", "INDUSTRY")
)
