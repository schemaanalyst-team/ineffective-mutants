-- 421
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OCCUPATIONCODE, OCCUPATIONCODE) with Pair(OCCUPATIONCODE, STABILITY)
...
CREATE TABLE "wage" (
	...
	"OCCUPATIONCODE"	INT	 REFERENCES "occupation" ("STABILITY")	NOT NULL,
	"MEANWEEKWAGE"	INT,
