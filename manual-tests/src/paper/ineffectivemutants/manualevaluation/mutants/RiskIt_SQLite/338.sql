-- 338
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(SSN, CITIZENSHIP)
...
CREATE TABLE "employmentstat" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("CITIZENSHIP")	NOT NULL,
