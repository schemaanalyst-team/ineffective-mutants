-- 262
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MIGRATIONMOVE, HOUSEHOLDDETAIL)
...
CREATE TABLE "migration" (
	...
	FOREIGN KEY ("SSN", "MIGRATIONMOVE") REFERENCES "userrecord" ("SSN", "HOUSEHOLDDETAIL")
)
