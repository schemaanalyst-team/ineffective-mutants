-- 324
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(EDUCATION, SSN)
...
CREATE TABLE "education" (
	"SSN"	INT	PRIMARY KEY	NOT NULL,
	"EDUCATION"	CHAR(50)	 REFERENCES "userrecord" ("SSN"),
	"EDUENROLL"	CHAR(50)
)
