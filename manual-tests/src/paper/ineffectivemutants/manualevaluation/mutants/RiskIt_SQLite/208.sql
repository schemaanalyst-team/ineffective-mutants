-- 208
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(WORKWEEKS, FATHERORIGIN)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("SSN", "WORKWEEKS") REFERENCES "userrecord" ("SSN", "FATHERORIGIN")
)
