-- 380
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(WORKCLASS, SSN)
...
CREATE TABLE "job" (
	"SSN"	INT	PRIMARY KEY	NOT NULL,
	"WORKCLASS"	CHAR(50)	 REFERENCES "userrecord" ("SSN"),
