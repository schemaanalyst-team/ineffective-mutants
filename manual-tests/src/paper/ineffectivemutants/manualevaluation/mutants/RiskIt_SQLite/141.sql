-- 141
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(OCCUPATIONCODE, DETAIL)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("SSN", "OCCUPATIONCODE") REFERENCES "userrecord" ("SSN", "DETAIL")
)
