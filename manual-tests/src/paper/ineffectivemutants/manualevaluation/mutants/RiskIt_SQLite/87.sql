-- 87
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(STOCKDIVIDENDS, HOUSEHOLDDETAIL)
...
CREATE TABLE "investment" (
	...
	"CAPITALLOSSES"	INT,
	"STOCKDIVIDENDS"	INT,
	FOREIGN KEY ("SSN", "STOCKDIVIDENDS") REFERENCES "userrecord" ("SSN", "HOUSEHOLDDETAIL")
)
