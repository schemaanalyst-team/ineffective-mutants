-- 502
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with HOUSEHOLDDETAIL
...
CREATE TABLE "userrecord" (
	...
	"TAXSTAT"	CHAR(50),
	"DETAIL"	CHAR(100),
	"HOUSEHOLDDETAIL"	CHAR(100)	PRIMARY KEY,
