-- 427
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(SSN, MARITAL)
...
CREATE TABLE "youth" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("MARITAL")	NOT NULL,
	"PARENTS"	CHAR(50)
)
