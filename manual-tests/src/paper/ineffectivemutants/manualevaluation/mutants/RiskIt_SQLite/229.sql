-- 229
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MIGRATIONCODE, ZIP)
...
CREATE TABLE "migration" (
	...
	FOREIGN KEY ("SSN", "MIGRATIONCODE") REFERENCES "userrecord" ("SSN", "ZIP")
)
