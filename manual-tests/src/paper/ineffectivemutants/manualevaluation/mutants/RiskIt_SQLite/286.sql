-- 286
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MEANWEEKWAGE, OCCUPATION)
...
CREATE TABLE "wage" (
	...
	FOREIGN KEY ("OCCUPATIONCODE", "MEANWEEKWAGE") REFERENCES "occupation" ("OCCUPATIONCODE", "OCCUPATION")
)
