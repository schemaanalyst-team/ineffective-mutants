-- 39
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(UNEMPLOYMENTREASON, CITIZENSHIP)
...
CREATE TABLE "employmentstat" (
	...
	FOREIGN KEY ("SSN", "UNEMPLOYMENTREASON") REFERENCES "userrecord" ("SSN", "CITIZENSHIP")
)
