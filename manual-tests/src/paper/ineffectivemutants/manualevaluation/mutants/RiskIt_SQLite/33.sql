-- 33
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(UNEMPLOYMENTREASON, TAXSTAT)
...
CREATE TABLE "employmentstat" (
	...
	FOREIGN KEY ("SSN", "UNEMPLOYMENTREASON") REFERENCES "userrecord" ("SSN", "TAXSTAT")
)
