-- 273
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MIGRATIONFROMSUNBELT, TAXSTAT)
...
CREATE TABLE "migration" (
	...
	FOREIGN KEY ("SSN", "MIGRATIONFROMSUNBELT") REFERENCES "userrecord" ("SSN", "TAXSTAT")
)
