-- 51
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EMPLOYMENTSTAT, BIRTHCOUNTRY)
...
CREATE TABLE "employmentstat" (
	...
	FOREIGN KEY ("SSN", "EMPLOYMENTSTAT") REFERENCES "userrecord" ("SSN", "BIRTHCOUNTRY")
)
