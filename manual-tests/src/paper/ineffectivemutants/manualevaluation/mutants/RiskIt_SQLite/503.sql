-- 503
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with FATHERORIGIN
...
CREATE TABLE "userrecord" (
	...
	"FATHERORIGIN"	CHAR(50)	PRIMARY KEY,
