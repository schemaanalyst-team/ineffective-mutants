-- 271
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MIGRATIONFROMSUNBELT, MARITAL)
...
CREATE TABLE "migration" (
	...
	FOREIGN KEY ("SSN", "MIGRATIONFROMSUNBELT") REFERENCES "userrecord" ("SSN", "MARITAL")
)
