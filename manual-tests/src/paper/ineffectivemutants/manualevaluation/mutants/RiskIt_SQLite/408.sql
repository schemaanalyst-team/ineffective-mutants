-- 408
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(SSN, MOTHERORIGIN)
...
CREATE TABLE "migration" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("MOTHERORIGIN")	NOT NULL,
