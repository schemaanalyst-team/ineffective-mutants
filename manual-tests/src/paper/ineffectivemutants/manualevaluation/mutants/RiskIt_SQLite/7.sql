-- 7
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EDUCATION, TAXSTAT)
...
CREATE TABLE "education" (
	...
	"EDUCATION"	CHAR(50),
	"EDUENROLL"	CHAR(50),
	FOREIGN KEY ("SSN", "EDUCATION") REFERENCES "userrecord" ("SSN", "TAXSTAT")
)
