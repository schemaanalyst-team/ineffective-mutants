-- 205
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(WORKWEEKS, TAXSTAT)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("SSN", "WORKWEEKS") REFERENCES "userrecord" ("SSN", "TAXSTAT")
)
