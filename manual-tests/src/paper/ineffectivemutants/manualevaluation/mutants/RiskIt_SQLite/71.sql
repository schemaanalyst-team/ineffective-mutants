-- 71
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(CAPITALLOSSES, RACE)
...
CREATE TABLE "investment" (
	...
	"CAPITALLOSSES"	INT,
	"STOCKDIVIDENDS"	INT,
	FOREIGN KEY ("SSN", "CAPITALLOSSES") REFERENCES "userrecord" ("SSN", "RACE")
)
