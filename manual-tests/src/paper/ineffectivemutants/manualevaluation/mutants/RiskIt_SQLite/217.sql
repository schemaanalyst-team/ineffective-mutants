-- 217
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(OCCUPATIONCODE, STABILITY)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("INDUSTRYCODE", "OCCUPATIONCODE") REFERENCES "industry" ("INDUSTRYCODE", "STABILITY")
)
