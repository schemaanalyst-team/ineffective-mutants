-- 43
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EMPLOYMENTSTAT, SEX)
...
CREATE TABLE "employmentstat" (
	...
	FOREIGN KEY ("SSN", "EMPLOYMENTSTAT") REFERENCES "userrecord" ("SSN", "SEX")
)
