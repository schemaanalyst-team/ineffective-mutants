-- 92
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(SSN, OCCUPATION)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("OCCUPATIONCODE", "SSN") REFERENCES "occupation" ("OCCUPATIONCODE", "OCCUPATION")
)
