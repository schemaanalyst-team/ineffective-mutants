-- 282
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MEANWEEKWAGE, INDUSTRY)
...
CREATE TABLE "wage" (
	...
	FOREIGN KEY ("INDUSTRYCODE", "MEANWEEKWAGE") REFERENCES "industry" ("INDUSTRYCODE", "INDUSTRY")
)
