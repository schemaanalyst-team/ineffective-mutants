-- 214
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(WORKCLASS, INDUSTRY)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("INDUSTRYCODE", "WORKCLASS") REFERENCES "industry" ("INDUSTRYCODE", "INDUSTRY")
)
