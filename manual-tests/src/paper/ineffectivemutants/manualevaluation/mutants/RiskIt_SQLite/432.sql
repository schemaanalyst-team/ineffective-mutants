-- 432
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(SSN, FATHERORIGIN)
...
CREATE TABLE "youth" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("FATHERORIGIN")	NOT NULL,
	"PARENTS"	CHAR(50)
)
