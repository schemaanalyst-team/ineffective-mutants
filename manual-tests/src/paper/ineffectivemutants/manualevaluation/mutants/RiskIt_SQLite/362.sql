-- 362
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OCCUPATIONCODE, OCCUPATIONCODE) with Pair(UNIONMEMBER, OCCUPATIONCODE)
...
CREATE TABLE "job" (
	...
	"OCCUPATIONCODE"	INT,
	"UNIONMEMBER"	CHAR(50)	 REFERENCES "occupation" ("OCCUPATIONCODE"),
	"EMPLOYERSIZE"	INT,
	"WEEKWAGE"	INT,
