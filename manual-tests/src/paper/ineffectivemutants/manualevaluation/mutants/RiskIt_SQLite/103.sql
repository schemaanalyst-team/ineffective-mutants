-- 103
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(WEEKWAGE, STABILITY)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("OCCUPATIONCODE", "WEEKWAGE") REFERENCES "occupation" ("OCCUPATIONCODE", "STABILITY")
)
