-- 455
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added INDUSTRY
...
CREATE TABLE "industry" (
	...
	"INDUSTRY"	CHAR(50),
	"STABILITY"	INT,
	PRIMARY KEY ("INDUSTRYCODE", "INDUSTRY")
)
