-- 276
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MIGRATIONFROMSUNBELT, FATHERORIGIN)
...
CREATE TABLE "migration" (
	...
	FOREIGN KEY ("SSN", "MIGRATIONFROMSUNBELT") REFERENCES "userrecord" ("SSN", "FATHERORIGIN")
)
