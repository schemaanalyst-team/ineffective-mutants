-- 100
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EMPLOYERSIZE, OCCUPATION)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("OCCUPATIONCODE", "EMPLOYERSIZE") REFERENCES "occupation" ("OCCUPATIONCODE", "OCCUPATION")
)
