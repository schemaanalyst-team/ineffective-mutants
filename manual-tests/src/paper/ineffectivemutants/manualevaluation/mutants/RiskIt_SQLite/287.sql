-- 287
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MEANWEEKWAGE, STABILITY)
...
CREATE TABLE "wage" (
	...
	FOREIGN KEY ("OCCUPATIONCODE", "MEANWEEKWAGE") REFERENCES "occupation" ("OCCUPATIONCODE", "STABILITY")
)
