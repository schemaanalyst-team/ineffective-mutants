-- 172
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EMPLOYERSIZE, CITIZENSHIP)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("SSN", "EMPLOYERSIZE") REFERENCES "userrecord" ("SSN", "CITIZENSHIP")
)
