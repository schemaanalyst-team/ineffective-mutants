-- 127
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(INDUSTRYCODE, TAXSTAT)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("SSN", "INDUSTRYCODE") REFERENCES "userrecord" ("SSN", "TAXSTAT")
)
