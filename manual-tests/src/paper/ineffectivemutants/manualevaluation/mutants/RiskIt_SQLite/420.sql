-- 420
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OCCUPATIONCODE, OCCUPATIONCODE) with Pair(OCCUPATIONCODE, OCCUPATION)
...
CREATE TABLE "wage" (
	...
	"OCCUPATIONCODE"	INT	 REFERENCES "occupation" ("OCCUPATION")	NOT NULL,
	"MEANWEEKWAGE"	INT,
