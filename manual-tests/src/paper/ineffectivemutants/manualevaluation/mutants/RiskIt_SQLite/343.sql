-- 343
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(SSN, AGE)
...
CREATE TABLE "investment" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("AGE")	NOT NULL,
	"CAPITALGAINS"	INT,
	"CAPITALLOSSES"	INT,
	"STOCKDIVIDENDS"	INT
)
