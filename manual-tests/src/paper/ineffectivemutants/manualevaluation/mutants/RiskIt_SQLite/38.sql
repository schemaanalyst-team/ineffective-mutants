-- 38
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(UNEMPLOYMENTREASON, BIRTHCOUNTRY)
...
CREATE TABLE "employmentstat" (
	...
	FOREIGN KEY ("SSN", "UNEMPLOYMENTREASON") REFERENCES "userrecord" ("SSN", "BIRTHCOUNTRY")
)
