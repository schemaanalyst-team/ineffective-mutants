-- 461
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added STABILITY
...
CREATE TABLE "occupation" (
	...
	"OCCUPATION"	CHAR(50),
	"STABILITY"	INT,
	PRIMARY KEY ("OCCUPATIONCODE", "STABILITY")
)
