-- 132
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(INDUSTRYCODE, BIRTHCOUNTRY)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("SSN", "INDUSTRYCODE") REFERENCES "userrecord" ("SSN", "BIRTHCOUNTRY")
)
