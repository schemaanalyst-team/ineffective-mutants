-- 32
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(UNEMPLOYMENTREASON, RACE)
...
CREATE TABLE "employmentstat" (
	...
	FOREIGN KEY ("SSN", "UNEMPLOYMENTREASON") REFERENCES "userrecord" ("SSN", "RACE")
)
