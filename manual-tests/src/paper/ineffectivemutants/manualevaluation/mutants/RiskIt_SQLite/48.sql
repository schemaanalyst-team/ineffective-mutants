-- 48
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EMPLOYMENTSTAT, HOUSEHOLDDETAIL)
...
CREATE TABLE "employmentstat" (
	...
	FOREIGN KEY ("SSN", "EMPLOYMENTSTAT") REFERENCES "userrecord" ("SSN", "HOUSEHOLDDETAIL")
)
