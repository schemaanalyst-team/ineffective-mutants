-- 414
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(MIGRATIONFROMSUNBELT, SSN)
...
CREATE TABLE "migration" (
	...
	"MIGRATIONFROMSUNBELT"	CHAR(50)	 REFERENCES "userrecord" ("SSN")
)
