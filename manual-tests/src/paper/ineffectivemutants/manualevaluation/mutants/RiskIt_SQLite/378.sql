-- 378
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(SSN, BIRTHCOUNTRY)
...
CREATE TABLE "job" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("BIRTHCOUNTRY")	NOT NULL,
	"WORKCLASS"	CHAR(50),
