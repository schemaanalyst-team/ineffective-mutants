-- 2
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EDUCATION, ZIP)
...
CREATE TABLE "education" (
	...
	"EDUCATION"	CHAR(50),
	"EDUENROLL"	CHAR(50),
	FOREIGN KEY ("SSN", "EDUCATION") REFERENCES "userrecord" ("SSN", "ZIP")
)
