-- 517
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged OCCUPATIONCODE with OCCUPATION
...
CREATE TABLE "occupation" (
	...
	"OCCUPATION"	CHAR(50)	PRIMARY KEY,
	"STABILITY"	INT
)
