-- 358
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(OCCUPATIONCODE, OCCUPATIONCODE) with Pair(WORKCLASS, OCCUPATIONCODE)
...
CREATE TABLE "job" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("SSN")	NOT NULL,
	"WORKCLASS"	CHAR(50)	 REFERENCES "occupation" ("OCCUPATIONCODE"),
