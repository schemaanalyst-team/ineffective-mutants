-- 506
-- PKCColumnE
-- ListElementExchanger with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Exchanged SSN with CITIZENSHIP
...
CREATE TABLE "userrecord" (
	...
	"CITIZENSHIP"	CHAR(50)	PRIMARY KEY
)
