-- 64
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(CAPITALGAINS, BIRTHCOUNTRY)
...
CREATE TABLE "investment" (
	...
	"CAPITALLOSSES"	INT,
	"STOCKDIVIDENDS"	INT,
	FOREIGN KEY ("SSN", "CAPITALGAINS") REFERENCES "userrecord" ("SSN", "BIRTHCOUNTRY")
)
