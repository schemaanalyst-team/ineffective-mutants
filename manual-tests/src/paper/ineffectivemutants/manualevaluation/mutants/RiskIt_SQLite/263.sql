-- 263
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(MIGRATIONMOVE, FATHERORIGIN)
...
CREATE TABLE "migration" (
	...
	FOREIGN KEY ("SSN", "MIGRATIONMOVE") REFERENCES "userrecord" ("SSN", "FATHERORIGIN")
)
