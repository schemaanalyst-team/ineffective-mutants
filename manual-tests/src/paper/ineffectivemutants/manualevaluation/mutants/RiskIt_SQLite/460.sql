-- 460
-- PKCColumnA
-- ListElementAdder with ChainedSupplier with PrimaryKeyConstraintSupplier and PrimaryKeyColumnsWithAlternativesSupplier - Added OCCUPATION
...
CREATE TABLE "occupation" (
	...
	"OCCUPATION"	CHAR(50),
	"STABILITY"	INT,
	PRIMARY KEY ("OCCUPATIONCODE", "OCCUPATION")
)
