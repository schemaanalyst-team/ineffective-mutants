-- 93
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(SSN, STABILITY)
...
CREATE TABLE "job" (
	...
	"WORKWEEKS"	INT,
	FOREIGN KEY ("OCCUPATIONCODE", "SSN") REFERENCES "occupation" ("OCCUPATIONCODE", "STABILITY")
)
