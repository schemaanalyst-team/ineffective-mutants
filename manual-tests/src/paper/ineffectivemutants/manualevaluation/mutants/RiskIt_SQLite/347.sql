-- 347
-- FKCColumnPairE
-- ListElementExchanger with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairWithAlternativesSupplier - Exchanged Pair(SSN, SSN) with Pair(SSN, TAXSTAT)
...
CREATE TABLE "investment" (
	"SSN"	INT	PRIMARY KEY	 REFERENCES "userrecord" ("TAXSTAT")	NOT NULL,
	"CAPITALGAINS"	INT,
	"CAPITALLOSSES"	INT,
	"STOCKDIVIDENDS"	INT
)
