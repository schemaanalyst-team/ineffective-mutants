-- 49
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EMPLOYMENTSTAT, FATHERORIGIN)
...
CREATE TABLE "employmentstat" (
	...
	FOREIGN KEY ("SSN", "EMPLOYMENTSTAT") REFERENCES "userrecord" ("SSN", "FATHERORIGIN")
)
