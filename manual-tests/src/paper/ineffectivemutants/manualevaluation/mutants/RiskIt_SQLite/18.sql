-- 18
-- FKCColumnPairA
-- ListElementAdder with ChainedSupplier with ForeignKeyConstraintSupplier and ForeignKeyColumnPairsWithAlternativesSupplier - Added Pair(EDUENROLL, MARITAL)
...
CREATE TABLE "education" (
	...
	"EDUCATION"	CHAR(50),
	"EDUENROLL"	CHAR(50),
	FOREIGN KEY ("SSN", "EDUENROLL") REFERENCES "userrecord" ("SSN", "MARITAL")
)
